<%-- 
    Document   : lien-he
    Created on : Sep 19, 2024, 1:54:38 AM
    Author     : PC
--%>
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="contact-us">
                            <h2 class="company-name">Honda Ô tô Long Biên</h2>
                            <p><strong data-lang="contact_address">Địa chỉ</strong> : Số 447 Nguyễn Văn Linh, Quận Long Biên, Hà Nội</p>
                            <p><strong data-lang="contact_phone">Điện thoại</strong> : <a href="tel:0966991930" title="Gọi ngay cho Chúng tôi">0966 991 930</a></p>
                            <p><strong data-lang="contact_email">Email</strong> : <a href="mailto:lehuong18293@gmail.com" target="_top">lehuong18293@gmail.com</a></p>
                            <p><strong>Website</strong> : <a title="Honda Ô tô Long Biên" href="index.html">https://hondaotolongbienhn.com</a></p>
                        </div>
                    </div>
                    <div class="col-md-7">
                        <div id="contactus">
